                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="hero-cap text-center">
                            <h3>Add Items for swapping</h3>
                        </div><br><br><br>
                        <form class="row contact_form" action="placeAd" novalidate="novalidate">
                            <div class="col-md-6 form-group p_star">
                            Artifact Id<input type="text" class="form-control" id="a_id" name="aid" />
                            <span class="placeholder"  ></span>
                            </div>
                            <div class="col-md-6 form-group p_star">
                            Name Of Artifact<input type="text" class="form-control" id="name" name="artifact" />
                            <span class="placeholder" ></span>
                            </div>
                            Category
